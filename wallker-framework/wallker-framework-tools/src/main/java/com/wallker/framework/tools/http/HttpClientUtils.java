...
public class HttpClientUtils {
	 ...
	 * 
	 */
	public String execute(String url, String encoding,
	...
	public String post(String url, String content)
		...
		return execute(url, "UTF-8", httpPost, httpClient);
	}
	...
	public byte [] postFile(String url) throws Exception{
		CloseableHttpClient httpClient = getHttpClient();
		CloseableHttpResponse response = null;
		try{
			HttpPost httpPost = new HttpPost(url);
	...
	public String postFile(String url,String fileName,File file) throws Exception{
		...
		return execute(url, "UTF-8", post, httpClient);
	}
